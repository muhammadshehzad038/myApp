...
<MyHeader
  ...
  />
<ImageBackground source={require('../assets/images/1.png')} resizeMode="cover" style={{justifyContent: 'center',}}>
...
<ScrollView>
   ...
   <View className="flex items-center bg-white p-3 rounded-4xl shadow-2xl mb-2 mx-2" style={{backgroundColor: themeColors.bg, marginTop:10, height: 250}}>
   <Text className="text-gray-700 ml-1 text-xl" style={{marginTop: 50}}>Estimated Delivery time</Text>
       ...
       <View className="flex-row">  
          ...
          <View className="flex-row justify-between px-5 pt-10">
              <View>
                  <Text className="text-lg text-gray-700 font-semibold">Delivered in</Text>
          ...
          className="p-2 flex-row justify-between items-center rounded-full my-5 mx-2">
            ...
            <View  className="flex-row items-center space-x-3 mr-3">
              ...
              <TouchableOpacity  onPress={()=> navigation.navigate('PersonalChat')} className="bg-white p-2 rounded-full">
                <Icon.MessageSquare fill={themeColors.bgColor(1)} stroke={themeColors.bgColor(1)} strokeWidth="5" />
              </TouchableOpacity>
