...
const AppHeader = ({
	...
	const RightView = () => (
		rightComponent ? rightComponent :
			<View style={[styles.view, styles.rightView]}>
				...
				{optionalBtn && <TouchableOpacity style={styles.rowView} onPress={()=> navigation.navigate('CartScreen')}>
	...
	return (
		<Surface style={[styles.header, style, { backgroundColor: themeColors.resbg }]}>
			<LeftView />
			<TitleView />
			<RightView />
		</Surface>
